...
CONSTANTES = {
    ...
    'labels_variaveis': {
        ...
        '[mm]': ['tp', 'chuva_ons', 'prec', 'acumulado_total', 'wind_prec_geop', 'diferenca', 'desvpad', 'tp_anomalia', 'chuva_acumualada_merge', 'chuva_acumualada_merge_anomalia', 'chuva_boletim_consumidores'],
